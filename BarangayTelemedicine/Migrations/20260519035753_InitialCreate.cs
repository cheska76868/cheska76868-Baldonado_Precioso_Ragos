        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedBarangay = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthWorkerId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_HealthWorkers_HealthWorkerId",
                        column: x => x.HealthWorkerId,
                        principalTable: "HealthWorkers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VitalSigns = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Consultations_HealthWorkers_HealthWorkerId",
                        column: x => x.HealthWorkerId,
                        principalTable: "HealthWorkers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_HealthWorkerId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consultations_HealthWorkerId",
                table: "Consultations",
                column: "HealthWorkerId");
